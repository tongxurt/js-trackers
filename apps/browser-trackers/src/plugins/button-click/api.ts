...
import {BrowserPlugin, BrowserTracker, dispatchToTrackersInCollection} from "../../core";
import {CommonEventProperties, DynamicContext, resolveDynamicContext} from "@capybara-trackers/core";
